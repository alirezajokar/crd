...
class CrudControllerCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $signature = 'jojo:controller
                            ...
                            {--r|resource : resource with model}
    ...
    protected function getStub()
    {
        ...
        ? config('crudgenerator.path') . '/controller'.$resource.'.stub'
...
EOD;
     ...
     * @return $this
     */
    protected function replaceModelNamelower(&$stub, $modelNamelower)
    {
    ...
    protected function replaceResource(&$stub, $resource)
    {
        $stub = str_replace('{{resourceController}}', $resource, $stub);
